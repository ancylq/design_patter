 1. static_factory_method ---- 简单工厂模式
 2. strategy              ---- 策略模式
 3. decorator             ---- 装饰模式
 4. proxy                 ---- 代理模式
 5. factory_method        ---- 工厂模式
 6. prototype             ---- 原型模式
 7. template_method       ---- 模板方法模式
 8. facade                ---- 外观模式
 9. builder               ---- 建造者模式
10. observer              ---- 观察者模式（也可叫发布-订阅(public/subscribe)模式）
11. abstract_factory      ---- 抽象工厂模式
12. state                 ---- 状态模式
13. adapter               ---- 适配器模式
14. memento               ---- 备忘录模式
15. composite             ---- 组合模式
